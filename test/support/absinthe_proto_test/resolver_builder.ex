defmodule AbsintheProtoTest.ResolverBuilder do
  def build_resolver(_service, resolver_name, _client) do
    quoted_content =
    ...
    Module.create(resolver_name, quoted_content, Macro.Env.location(__ENV__))
  end
end